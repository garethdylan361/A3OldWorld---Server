...
{
	if(!(ch[cn].flags&CF_NOEXP)) {
		if (areaID == 21) return;    // !!!!!!!!!!!!!!!!! hack !!!!!!!!!!!!!!!

		if (ch[cn].exp < 200 * 200 * 200 * 200) ch[cn].exp += val * 2;
...
int create_orb_by_name(char *name)
{
	int in;
	int what;
	...
	if(strcmp(name, "endurance") == 0) { what=V_ENDURANCE; }
	else if(strcmp(name, "hp") == 0) { what=V_HP; }
	else if(strcmp(name, "mana") == 0) { what=V_MANA; }
	else if(strcmp(name, "wisdom") == 0) { what=V_WIS; }
	else if(strcmp(name, "intuition") == 0) { what=V_INT; }
	else if(strcmp(name, "agility") == 0) { what=V_AGI; }
	else if(strcmp(name, "strength") == 0) { what=V_STR; }
	else if(strcmp(name, "barter") == 0) { what=V_BARTER; }
	else if(strcmp(name, "perception") == 0) { what=V_PERCEPT; }
	else if(strcmp(name, "stealth") == 0) { what=V_STEALTH; }
	else if(strcmp(name, "hand") == 0) { what=V_HAND; }
	else if(strcmp(name, "warcry") == 0) { what=V_WARCRY; }
	else if(strcmp(name, "surround") == 0) { what=V_SURROUND; }
	else if(strcmp(name, "bodycontrol") == 0) { what=V_BODYCONTROL; }
	else if(strcmp(name, "speedskill") == 0) { what=V_SPEEDSKILL; }
	else if(strcmp(name, "heal") == 0) { 	what=V_HEAL; }
	else if(strcmp(name, "fireball") == 0) { what=V_FIREBALL; }
	else if(strcmp(name, "tactics") == 0) { what=V_TACTICS; }
	else if(strcmp(name, "duration") == 0) { what=V_DURATION; }
	else if(strcmp(name, "rage") == 0) { what=V_RAGE; }
	else if(strcmp(name, "bless") == 0) { what=V_BLESS; }
	else if(strcmp(name, "freeze") == 0) { what=V_FREEZE; }
	else if(strcmp(name, "dagger") == 0) { what=V_MAGICSHIELD; }
	else if(strcmp(name, "lf") == 0) { what=V_FLASH; }
	else if(strcmp(name, "pulse") == 0) { what=V_PULSE; }
	else if(strcmp(name, "dagger") == 0) { what=V_DAGGER; }
	else if(strcmp(name, "staff") == 0) { what=V_STAFF; }
	else if(strcmp(name, "sword") == 0) { what=V_SWORD; }
	else if(strcmp(name, "th") == 0) { what=V_TWOHAND; }
	else if(strcmp(name, "attack") == 0) { what=V_ATTACK; }
	else if(strcmp(name, "parry") == 0) { 	what=V_PARRY; }
	else if(strcmp(name, "imm") == 0) { what=V_IMMUNITY; }
	else { elog("unknown %s in create_orb()", name); what=V_HP; }
